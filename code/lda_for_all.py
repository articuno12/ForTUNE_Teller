...
data = pd.read_csv("../dataset/final_dataset_cleaned.csv")
...
X_t21 = X_train.drop("data_set_id",axis =1)
X_t = X_t21.drop("viewCount",axis =1)
#X_t = X_t.drop("data_set_id", axis=1)
X_tt= X_t.drop("label",axis =1)
X_TRAIN = X_tt.drop("ID",axis =1)

X_t221 = X_test.drop("data_set_id",axis =1)
X_t1 = X_t221.drop("viewCount",axis =1)
